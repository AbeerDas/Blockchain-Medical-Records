...
contract MedicalRecords {
    ...
    function getHomeAddress(uint _recordId) public view returns (string memory) {
        return records[_recordId].homeAddress;
    }

    function getPhoneNumber(uint _recordId) public view returns (string memory) {
        return records[_recordId].phoneNumber;
    }

    function getEmailAddress(uint _recordId) public view returns (string memory) {
        return records[_recordId].emailAddress;
    }
