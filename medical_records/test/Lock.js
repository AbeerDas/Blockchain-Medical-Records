...
describe("MedicalRecords", () => {
  ...
  describe("Add Record", () => {
    ...
    it("Emits a Add Record event", async () => {
      ...
      expect(args.homeAddress).to.equal("47 James Drive");
      expect(args.emailAddress).to.equal("abeerdas647@gmail.com");
      expect(args.phoneNumber).to.equal("647 423 4434");
    ...
    it("The getRecords function is working", async () => {
      ...
      expect(homeAddress).to.equal("47 James Drive");
      expect(emailAddress).to.equal("abeerdas647@gmail.com");
      expect(phoneNumber).to.equal("647 423 4434");
